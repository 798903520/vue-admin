  ...
  <div class="home">
    ...
    <div class="tables">
      <el-table :data="typeList.data" border style="width: 100%" @select="handleSelecChange"
        ...
        <el-table-column prop="content" align="center" label="商品说明"> </el-table-column>
        <el-table-column prop="color" align="center" label="商品颜色"> </el-table-column>
        <el-table-column prop="size" align="center" label="商品分类"> </el-table-column>
        <el-table-column prop="price" align="center" label="商品价格"> </el-table-column>
        <el-table-column prop="create_product_time" align="center" label="入驻时间"></el-table-column>
        <el-table-column label="操作" align="center" width="200">
          <template #default="scope">
            <el-button text type="primary" @click="addORedit(scope.row.product_id)">编辑</el-button>
            <el-button text type="primary" @click="deleteMoreAndOne(scope.row.product_id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    // 获取列表数据
    getList() {
      http.get('/table/get_p_List', this.query).then((res) => {
        if (res.code == '200') {
          this.typeList = res;
          this.$forceUpdate();
